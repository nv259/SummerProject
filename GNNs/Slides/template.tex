...
%------------------------------------------------
%\subsection{Sampling Graphs and Batching in GNNs}
\begin{frame}
    \centering
    \Large
...
\begin{frame}{Generative Modelling}
	\centering	
	\only<1>{
		\includegraphics[scale=.5]{Images/permutation_invariant.png}
	}
	
	\only<2>{
		\includegraphics[scale=.5]{Images/long_range_dependency.png}
	}
\end{frame}
%---------------------------------------------------------
